  ...
  <div class="test">
    ...
    <div class="job-list d-flex">
      <div class="job d-flex">
        <div class="job-top">
          <a class="" href=""><img src="public/images/ct2.jpg" alt=""></a>
        </div>
      ...
      <div class="job d-flex">
        <div class="job-top">
          <a class="" href="company-detail.html"><img src="public/images/ct2.jpg" alt=""></a>
        </div>
        <div class="job-content">
          <div class="job-title">
      ...
      <div class="job d-flex">
        <div class="job-top">
          <a class="" href=""><img src="public/images/ct4.png" alt=""></a>
        </div>
        <div class="job-content">
          <div class="job-title">
            <a href="">Junior Graphic Designer (Web)</a>
      ...
      <div class="job d-flex">
        <div class="job-top">
          <a class="" href=""><img src="public/images/ct1.png" alt=""></a>
        </div>
        <div class="job-content">
          <div class="job-title">
            <a href="">Junior Graphic Designer (Web)</a>
    ...
    <div class="page-wrapper">
      <div class="post-slider">
        ...
        <div class="post-wrapper">
          <div class="post">
            <img src="public/images/ct5.png" class="slider-image" alt="" />
          </div>
          <div class="post">
            <img src="public/images/ct5.png" class="slider-image" alt="" />
          </div>
